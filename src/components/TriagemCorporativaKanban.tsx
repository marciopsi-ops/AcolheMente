...
export const TriagemCorporativaKanban: React.FC<TriagemCorporativaKanbanProps> = ({
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl p-4 sm:p-5 border border-soft shadow-xs flex flex-col md:flex-row md:items-center justify-between gap-3">
        <div>
          ...
          <h2 className="text-base sm:text-lg font-bold font-serif text-forest">
            Esteira & Kanban Corporativo
          </h2>
          <p className="text-[11px] text-forest/70 max-w-2xl mt-0.5 leading-relaxed">
        ...
        <div className="flex items-center gap-1 bg-warm p-0.5 rounded-xl border border-soft self-start md:self-auto shrink-0">
          <button
            type="button"
